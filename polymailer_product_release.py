...
def find_emerging_product_candidates(
    ...
    for index, sam_mask in enumerate(masks):
        ...
        if corridor_overlap < EMERGING_MIN_CORRIDOR_OVERLAP:
            continue
        ...
        if (
            contact_overlap < EMERGING_MIN_CONTACT_OVERLAP
            ...
            while pipeline.isRunning():
                ...
                if key == ord(" "):
                    if not warmed:
                        ...
                        if not initialized:
                            print(
                                "Could not initialize optical-flow tracking. "
                                "Keep the polymailer still and press SPACE again."
                            )
                            tracker.clear()
                            baseline_mask = None
                            baseline_roi_rgb = None
